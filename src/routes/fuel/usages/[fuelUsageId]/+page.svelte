...
<section class="bg-white dark:bg-gray-900">
    <div class="py-2 px-4 mx-auto max-w-2xl lg:py-16">
        <form method="POST">
            <h2 class="mb-4 text-xl font-semibold leading-none text-gray-900 dark:text-white">แก้ไขการใช้รถ</h2>
            <div class="grid gap-4 mb-4 md:gap-6 md:grid-cols-2 sm:mb-8">
                ...
                <input type="number" name="fuelUsageId" id="fuelUsageId" bind:value={data.fuelUsageId} class="hidden">
            </div>
            <div class="flex justify-between space-x-4">
                <button type="submit" formaction="?/deleteFuelUsage" class="inline-flex items-center px-5 py-2.5 text-md font-medium text-center text-white bg-red-700 rounded-lg focus:ring-4 focus:ring-red-200 dark:focus:ring-red-900 hover:bg-red-800">
                    ลบ
                </button>
                <button type="submit" formaction="?/updateFuelUsage" class="inline-flex items-center px-5 py-2.5 text-md font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                    ยืนยัน
                </button>
            </div>
        </form>
